var hljs = (function () {
      ...
      mergeStreams: function (e, n, s) {
        ...
        for (; e.length || n.length; )
          if (
            ...
            c.reverse().forEach(u);
            do h(o.splice(0, 1)[0]), (o = l());
            while (o === e && o.length && o[0].offset === i);
            c.reverse().forEach(d);
          } else
    ...
    return (function (t) {
      ...
      function g(t, o, l, u) {
            ...
            ? (function () {
                if ("" !== m) {
                  ...
                  if ("string" == typeof h.subLanguage) {
                    if (!r[h.subLanguage]) return void f.addText(m);
                    (e = g(h.subLanguage, m, !0, M[h.subLanguage])),
                      (M[h.subLanguage] = e.top);
                  } else e = b(m, h.subLanguage.length ? h.subLanguage : null);
                  h.relevance > 0 && (w += e.relevance),
                    f.addSublanguage(e.emitter, e.language);
                }
              })()
            : (function () {
                if (!h.keywords) return void f.addText(m);
                let n = 0;
                ...
                for (; e; ) {
                  ...
                  if (s) {
                    const [n, o] = s;
                    f.addText(t), (t = ""), (w += o), f.addKeyword(e[0], n);
                  } else t += e[0];
                  (n = h.keywordPatternRe.lastIndex),
                    (e = h.keywordPatternRe.exec(m));
                }
                (t += m.substr(n)), f.addText(t);
              })(),
            (m = "");
        }
        function S(e) {
          return (
            e.className && f.openNode(e.className),
            (h = Object.create(e, {
              parent: {
                value: h,
              },
        ...
        function T(e) {
          return 0 === h.matcher.regexIndex ? ((m += e[0]), 1) : ((x = !0), 0);
        }
        y = {};
        function F(e, n) {
          var o,
            s = n && n[0];
          if (((m += e), s == null)) return C(), 0;
          if (
            "begin" === y.type &&
            "end" === n.type &&
            y.index === n.index &&
            ...
            if (((m += v.slice(n.index, n.index + 1)), !c)) {
              const e = Error("0 width match regex");
              throw ((e.languageName = t), (e.badRule = y.rule), e);
            }
            return 1;
          }
          if (((y = n), "begin" === n.type))
            return (function (e) {
              ...
              for (const t of o) if (t && (t(e, s), s.ignore)) return T(n);
              return (
                t &&
                  t.endSameAsBegin &&
                  (t.endRe = RegExp(
            ...
            ((o = (function (e) {
              var n,
                ...
                t = (function e(t, n, s) {
                  ...
                  if (t.endsWithParent) return e(t.parent, n, s);
                })(h, e, o);
              if (!t) return d;
              (n = h),
                n.skip
                  ? (m += s)
                  : (n.returnEnd || n.excludeEnd || (m += s),
                    C(),
                    n.excludeEnd && (m = s));
              do
              ...
              return (
                t.starts &&
                  (t.endSameAsBegin && (t.starts.endRe = t.endRe), S(t.starts)),
                ...
                (this.matcherRe = n(
                  (function (e, t = "|") {
                    for (
                      ...
                      (c = r += 1), (i = s(e[a]));
                      for (a > 0 && (o += t), o += "("; i.length > 0; ) {
                        if (((n = l.exec(i)), n == null)) {
                          o += i;
                          break;
                        }
            ...
            return (function o(r, c) {
              ...
              if (
                ("object" == typeof r.keywords &&
                  ((d = r.keywords.$pattern), delete r.keywords.$pattern),
                r.keywords &&
              ...
              return (
                (l.keywordPatternRe = n(r.lexemes || d || /\w+/, !0)),
                c &&
                  (r.beginKeywords &&
                    ((r.begin =
                      "\\b(" +
                  ...
                  r.endsWithParent &&
                    c.terminator_end &&
                    (l.terminator_end += (r.end ? "|" : "") + c.terminator_end)),
                  ...
                  ...r.contains.map(function (t) {
                    return (function (t) {
                      return (
                        t.variants &&
                          !t.cached_variants &&
                          (t.cached_variants = t.variants.map(function (n) {
                            return e(
                              t,
                              {
                                variants: null,
          ...
          t
            ...
            .forEach(function (t) {
              ...
              (n.language = t),
                ...
                n.relevance > s.relevance && ((o = s), (s = n));
            }),
      ...
      function x(e) {
        ...
        const s = (function (e) {
          ...
          return t
            ? ((o = i(t[1])),
              o ||
                (console.warn(E.replace("{}", t[1])),
                console.warn(
                  "Falling back to no-highlight mode for this block.",
                  e
                )),
              o ? t[1] : "no-highlight")
            : s.split(/\s+/).find((e) => y(e) || i(e));
        })(e);
        if (y(s)) return;
        l("before:highlightBlock", {
          ...
          n.useBR
            ? ((o = document.createElement("div")).innerHTML = e.innerHTML
                .replace(/\n/g, "")
                .replace(
                  /<br[ /]*>/g,
                  `
  `
        ...
        if (r.length) {
          ...
          (e.innerHTML = t.value), (t.value = S(r, u(e), a));
        }
        (t.value = w(t.value)),
      ...
      function i(e) {
        return (e = (e || "").toLowerCase()), r[e] || r[v[e]];
      }
      ...
      for (const e in o) "object" == typeof o[e] && m(o[e]);
            ...
            (d = r.contains.concat([
              {
                ...
                contains: ["self"].concat(r.contains, [
    ...
    hljs.registerLanguage(
      ...
      (function () {
        ...
        return function (e) {
          ...
          return (
            o.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, d, u, l, h),
            {
              name: "Less",
              case_insensitive: !0,
              illegal: "[=>'/<($\"]",
    ...
    hljs.registerLanguage(
      ...
      (function () {
        ...
        return function () {
          ...
          t.contains.push(n), n.contains.push(t);
          var s = [o, i];
          return (
            (t.contains = t.contains.concat(s)),
